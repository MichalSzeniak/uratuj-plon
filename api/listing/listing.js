...
export default async function handler(req, res) {
  ...
  // Dla WSZYSTKICH listingów
  const listingData = {
    title: `Oferta ${slug}`,
    description: `Zobacz tę wyjątkową ofertę nieruchomości. Unikalna okazja inwestycyjna.`,
    image: "https://ratujplon.pl/og-image2.jpg",
  };

  // Specyficzne listingi (opcjonalnie)
  const specificListings = {
    "b9e91b1d-7c24-465e-9015-cd1e63eeec57": {
      title: "Mieszkanie Warszawa - Centrum",
      description:
        "Przestronne mieszkanie 65m² w centrum Warszawy z widokiem na park.",
      image: "https://ratujplon.pl/og-image2.jpg",
    },
  };

  const finalData = specificListings[slug] || listingData;
  ...
  res.send(`
    ...
    <body>
        <script>window.location.href = '/listing/${slug}';</script>
    </body>
    </html>
  `);
}
